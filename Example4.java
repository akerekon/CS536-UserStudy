public class Example4 {
    ...
    private void checkIfPlayersOnField() {
        if (!firstBase.isEmpty() && !secondBase.isEmpty() && !shortstop.isEmpty()
           && !thirdBase.isEmpty() && !leftField.isEmpty() && !centerField.isEmpty()
           && !rightField.isEmpty() && !pitcher.isEmpty() && !catcher.isEmpty()) {
